export default function Hero() {
  return (
    <section className="relative min-h-screen overflow-hidden border-b border-[#0F2742]/15 pt-30 md:pt-36">
      <div className="lux-container grid gap-14 pb-24 md:grid-cols-12 md:gap-12 md:pb-32">
        <div className="order-2 md:order-1 md:col-span-7 md:col-start-2 md:self-end">
          ...
          <h1 className="font-[family-name:var(--font-display)] text-5xl leading-[0.9] tracking-tight text-[#0F2742] sm:text-6xl md:text-8xl lg:text-9xl">
            Presencia
            <br />
            digital <span className="italic text-[#2F78C4]">que vende</span>
            <br />
            en Puerto Rico
          </h1>

          <p className="drop-cap mt-8 max-w-xl text-base leading-relaxed text-[#4F6680] md:text-lg">
        ...
        <div className="order-1 md:order-2 md:col-span-4 md:col-start-9 md:pt-10">
          <div className="group relative overflow-hidden">
            ...
            />
            <span className="vertical-label absolute right-3 top-4 hidden text-[10px] uppercase tracking-[0.25em] text-[#0F2742]/70 md:block">
              Editorial / Vol. 01
            </span>
          </div>
          <p className="mt-4 max-w-sm text-sm leading-relaxed text-[#4F6680]">
